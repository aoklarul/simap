...
<head>
  ...
  <link href="<?= base_url() ?>assets/src/assets/css/light/pages/error/error.css" rel="stylesheet" type="text/css" />

  <link href="<?= base_url() ?>assets/layouts/modern-light-menu/css/dark/plugins.css" rel="stylesheet" type="text/css" />
  <link href="<?= base_url() ?>assets/src/assets/css/dark/pages/error/error.css" rel="stylesheet" type="text/css" />
...
<body class="error text-center">
    ...
    <div class="row">
      <div class="col-md-4 mr-auto mt-5 text-md-left text-center">
        <a href="index.html" class="ml-md-5">
          <img alt="image-404" src="<?= base_url() ?>assets/src/assets/img/logo.svg" class="dark-element theme-logo">
          <img alt="image-404" src="<?= base_url() ?>assets/src/assets/img/logo2.svg" class="light-element theme-logo">
        </a>
      </div>
    </div>
  </div>
  <div class="container-fluid error-content">
    <div class="">
      ...
      <p class="error-text mb-5 mt-1">Maaf, halaman tidak tersedia!</p>
      <img src="<?= base_url() ?>assets/src/assets/img/error.svg" alt="cork-admin-404" class="error-img">
      <a href="javascript:window.history.go(-1);" class="btn btn-dark mt-5">Go Back</a>
    </div>
  </div>
