...
<div class="row layout-top-spacing">
  ...
  <div class="action-btn mb-3">
    <a href="<?= site_url('kelurahan/create') ?>" type="button" class="btn btn-secondary">
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td><?= $row->kecamatan ?></td>
                <td>
                  <a href="<?= base_url('assets/geojson/kelurahan/') . $row->geojson ?>" target="_blank">
                    <?= $row->geojson ?>
                  </a>
                </td>
                <td class="text-center">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                      <a class="dropdown-item" href="<?= site_url('kelurahan/edit/') . $row->id ?>">Ubah Data</a>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <a type="button" class="btn btn-primary" href="<?= site_url('kelurahan/delete/') . $row->id ?>">Hapus Data</a>
                </div>
              </div>
            </div>
          </div>
