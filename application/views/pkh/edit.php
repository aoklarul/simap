        ...
        <div class="col-lg-6 col-md-6">
          <form action="" method="POST">
            ...
            <div class="form-group mb-4">
              ...
              <select class="form-select <?= form_error('idKelurahan') ? 'is-invalid' : '' ?>" id="idKelurahan" name="idKelurahan" disabled>
                <?php foreach ($kelurahan as $row) : ?>
                  <?php if ($row->id == $jumlah_pkh->idKelurahan) : ?>
            ...
            <div class="form-group mb-4">
              ...
              <select class="form-select <?= form_error('bulan') ? 'is-invalid' : '' ?>" id="bulan" name="bulan" disabled>
                <?php foreach ($bulan as $row) : ?>
                  <?php if ($row['id'] == $jumlah_pkh->bulan) : ?>
                    <option value="<?= $row['id'] ?>" selected><?= $row['month'] ?></option>
                  <?php endif; ?>
                <?php endforeach; ?>
              </select>
            ...
            <div class="form-group mb-4">
              ...
              <select class="form-select <?= form_error('tahun') ? 'is-invalid' : '' ?>" id="tahun" name="tahun" disabled>
                <?php for ($y = date('Y'); $y >= 2010; $y--) : ?>
                  <?php if ($y == $jumlah_pkh->tahun) : ?>
            ...
            <div class="form-group mb-4">
              ...
              <input type="text" class="form-control <?= form_error('jumlah') ? 'is-invalid' : '' ?>" id="jumlah" name="jumlah" value="<?= $jumlah_pkh->jumlah ?>" placeholder="Jumlah PKH">
